...
<Card title="Get API Key" icon="key" href="https://app.countrystatecity.in">
  Register for free API access with 150 requests per day
</Card>
...
<Step title="Get API Access">
  [Register for a free API key](https://app.countrystatecity.in) to start with 150 requests per day, or explore database installation guides for self-hosted solutions.
</Step>
