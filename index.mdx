...
<Step title="Get API Access">
  [Register for a free API key](https://app.countrystatecity.in) to start with 1000 requests per day, or explore database installation guides for self-hosted solutions.
</Step>
