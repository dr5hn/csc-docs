...
<Accordion title="How do I get an API key?">
  Register for free at [our portal](https://countrystatecity.in) to obtain your API key instantly. The process is simple:

  1. Visit [countrystatecity.in](https://countrystatecity.in)
