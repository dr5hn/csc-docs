...
api: "GET https://api.countrystatecity.in/v1/regions/{id}/subregions"
authMethod: "key"
...
<Note>**Availability:** Starter plan and above.</Note>
...
<ParamField query="q" type="string">
  Search filter on subregion name. Min 2 characters. Requires Starter+ plan.
</ParamField>
