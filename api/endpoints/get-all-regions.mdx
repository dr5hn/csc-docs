...
<Note>**Availability:** Starter plan and above. Returns `403` on lower tiers.</Note>
...
<ParamField query="q" type="string">
  Search filter on region name. Case-insensitive, minimum 2 characters. Requires Starter+ plan.
</ParamField>
