...
Look up a postcode / ZIP code within a country and get back every matching record. Use this to confirm that a user-supplied postcode appears in the dataset — for example, catching an obvious typo in a checkout form before you accept it.
