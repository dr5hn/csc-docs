...
Look up a postcode / ZIP code within a country and get back every matching record. Use this to confirm a user-supplied postcode exists — for example, validating a checkout address before you charge a card.
