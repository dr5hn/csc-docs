...
<Note>
  **Available on Professional and Business plans.** Returns `403` on Community, Starter, Supporter, and Legacy plans. [Compare plans](https://countrystatecity.in/pricing?source=docs&campaign=data_change_feed) to add the change feed to your API key.
</Note>
...
```json 403 - Professional plan required
{
  "status": "error",
