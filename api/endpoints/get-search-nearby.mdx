...
<Note>**Availability:** Supporter, Professional, and Business plans. Other plans receive `403`. [Compare plans](https://countrystatecity.in/pricing?source=playground&campaign=nearby_search), or see **Trying it without a paid plan** below.</Note>
...
<ResponseExample>
```json 200 - Cities near Mumbai (Supporter, Professional, Business)
[
  {
    "id": 57606,
    "name": "Mumbai",
...
The interactive API documentation uses a shared **Playground** plan. It is only for trying the endpoint in the docs. For your own app, [choose a Supporter plan or higher](https://countrystatecity.in/pricing?source=playground&campaign=nearby_search).
