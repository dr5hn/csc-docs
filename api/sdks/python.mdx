...
[Create a free API key](https://app.countrystatecity.in/?source=sdk_docs&campaign=sdk_api_migration&package=countrystatecity-api&utm_source=docs&utm_medium=documentation&utm_campaign=python_packages&utm_content=python_sdk) and [compare plans](https://countrystatecity.in/pricing/?source=sdk_docs&campaign=sdk_api_migration&package=countrystatecity-api&utm_source=docs&utm_medium=documentation&utm_campaign=python_packages&utm_content=python_sdk).
...
<CardGroup cols={2}>
  <Card title="Get a free API key" icon="key" href="https://app.countrystatecity.in/?source=sdk_docs&campaign=sdk_api_migration&package=countrystatecity-api&utm_source=docs&utm_medium=documentation&utm_campaign=python_packages&utm_content=python_sdk_card">
    Start on the free tier and create a server-side API key.
  </Card>
  <Card title="Compare API plans" icon="credit-card" href="https://countrystatecity.in/pricing/?source=sdk_docs&campaign=sdk_api_migration&package=countrystatecity-api&utm_source=docs&utm_medium=documentation&utm_campaign=python_packages&utm_content=python_sdk_card">
