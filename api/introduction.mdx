...
description: "Access comprehensive geographical data with our RESTful API featuring 247+ countries, 5000+ states, and 150,000+ cities"
icon: "globe"
---

## Overview

The Country State City API provides developers with comprehensive access to geographical data covering 247+ countries, 5000+ states/provinces, and over 150,000 cities worldwide. Our RESTful API is designed for high performance, reliability, and ease of integration.
