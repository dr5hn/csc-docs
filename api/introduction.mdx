...
description: "Access comprehensive geographical data with our RESTful API featuring 250 countries, 5000+ states, and 151,000+ cities"
icon: "globe"
---

## Overview

The Country State City API provides developers with comprehensive access to geographical data covering 250 countries, 5000+ states/provinces, and over 151,000 cities worldwide. Our RESTful API is designed for high performance, reliability, and ease of integration.

<Card
  title="Get your API key"
  icon="key"
  href="https://app.countrystatecity.in"
  horizontal
>
...
```json
{
  ...
  "total": 250,  // Total count (for list endpoints)
