...
Get free trial credits and create your first custom export
</Card>
</Tab>
...
| Use Case | Data Needed | Format |
|:---------|:------------|:--------|
| **E-commerce Checkout** | Countries with currencies | JSON |
| **Location Services** | Cities with coordinates | JSON |
| **Data Analytics** | Countries with coordinates/timezones | CSV |
...
>
  See current credit costs for all export types
</Card>
...
<Step title="Sign Up Free">
  Get free trial credits instantly
</Step>
...
<Tip>
**Free Trial**: Start with free trial credits to test the system. [View pricing](https://countrystatecity.in/pricing) for details.
</Tip>
