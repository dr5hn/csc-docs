...
<Note>
**Ready to implement your use case?** Start with the [getting started guide](/tools/export-tool/getting-started) to create your account and get 5 free credits for testing.
</Note>
