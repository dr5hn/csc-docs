...
3. **Get 3 free credits** automatically added to your account
4. **Create your first export** following our [getting started guide](/tools/export-tool/getting-started)

<Tip>
**Free Trial**: Every new user gets 3 credits to test the system before purchasing additional credits.
</Tip>
</Accordion>

<Accordion title="What can I do with the 3 free trial credits?">
Your 3 free credits give you several options:
...
**Option 2: Analysis Ready**
- Countries export in CSV format (1 + 1 = 2 credits)
- 1 credit remaining for another small export
...
- *Note: This would require purchasing 1 additional credit*
</Accordion>
...
<Accordion title="Is there a bulk discount for large purchases?">
**Smart Purchasing Strategy:**
- Calculate your project needs first
- Consider purchasing larger packages for better value
- Credits never expire, so buying ahead saves money
- Share credits across team members

Contact us at export@countrystatecity.in for custom pricing.
</Accordion>
</AccordionGroup>
