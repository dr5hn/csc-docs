...
<Card title="Quick Start" icon="rocket" href="/tools/export-tool/getting-started">
  Sign up and get 3 free credits to test the system
</Card>
...
Choose GitHub or email sign-up and receive 3 free credits to test the system.
</Step>
...
Get started today with 3 free credits and see how the CSC Export Tool can streamline your development workflow.
<CardGroup>
